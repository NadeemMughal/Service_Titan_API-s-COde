...
local_start_time = datetime(2025, 5, 26, 13, 0, 0)  # May 26, 2025, at 1 PM PST
local_end_time = datetime(2025, 5, 26, 14, 0, 0)  # May 26, 2025, at 2 PM PST
...
def add_appointment():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("ServiceTitan API returned a 400 Bad Request.")
            try:
